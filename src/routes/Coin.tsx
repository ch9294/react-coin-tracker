...
import {Route, Switch, Link, useLocation, useParams, useRouteMatch} from "react-router-dom";
...
const Coin = () => {
    ...
    const {isLoading: tickersLoading, data: tickersData} = useQuery<PriceDataProps>(["tickers", coinId], () => fetchPriceInfo(coinId));
